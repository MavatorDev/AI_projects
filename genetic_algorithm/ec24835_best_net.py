...
class Net(nn.Module):
    def __init__(self, D=3, K=4):
        super().__init__()
        layers = [nn.Linear(in_features=3334, out_features=271, bias=True), nn.ReLU(), nn.Linear(in_features=271, out_features=6, bias=True),nn.Dropout(0.10227016708579334)]
